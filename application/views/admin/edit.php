        ...
        <div class="col-lg-8">
            <form class="needs-validation" action="" method="post" enctype="multipart/form-data" novalidate>
               ...
               <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control tanggal" name="ttl_tanggal" id="ttl_lahir" value="<?= date('d-m-Y', strtotime($data['ttl_tanggal'])) ?>" required>
                ...
                <div class="form-group row">
                    <label for="nama_ayah" class="col-sm-3 col-form-label">Nama Orang Tua</label>
                    <div class="col-sm-9">
